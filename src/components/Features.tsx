...
const features = [
  {
    ...
    description: `No account necessary! BitHustle is built on top of the nostr protocol which uses a private key for your “password”`,
  },
  {
    icon: EyeOff,
    title: "Private",
    description: `You can zap anonymously to keep your identity private. BitHustle never touches your traditional payment methods so there’s no KYC.`,
  },
  {
    icon: HeartHand,
    title: "Any Cause",
    description: `BitHustle empowers individuals to fund any cause close to their hearts, whether it's supporting a creative project, helping a charitable organization, or fueling personal ambitions.`,
  },
  {
    icon: Percent,
    title: "Zero fees",
  ...
  },
  {
    icon: Target,
    title: "Any Goal",
    description: `BitHustle doesn’t care what you raise for. As long as your goals abides by our terms and conditions, we will display them.`,
  },
  {
    icon: ZapFast,
